        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="big-title">{{ config('app.empresas.slogan') }}</div>
                    <div class="sub-title">{{ config('app.empresas.subtitulo') }}</div>
                    <div class="domain-search-holder">
                        <form id="domain-search">
                            <input id="domain-text" type="text" name="domain" placeholder="Pesquise o domínio desejado" />
            ...
            <div class="row">
                <div class="col-md-12">
                    @if (session()->has('nossosServicos'))
                        <div class="row-title">{{ session('nossosServicos')->titulo }}</div>
                        <div class="row-subtitle">{{ session('nossosServicos')->descricao }} </div>
                    @endif
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row rtl-cols">
                ...
                <div class="col-sm-8 col-md-8 info-text-holder">
                    ...
                    <p>Aliquam consectetur aliquet libero, ut viverra velit bibendum a. Nullam et sapien ac eros feugiat
                        sollicitudin. Nulla euismod lorem nisi, a tempor diam fringilla ut. Nunc sed consectetur mauris.
                        Nullam ac sem elit. Vestibulum porta odio lacinia mauris pulvinar sagittis. Curabitur id cursus leo.
                    </p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-8 col-md-8 info-text-holder text-right">
                    ...
                    <p>Etiam condimentum metus rhoncus purus pharetra tempor. Sed faucibus lectus quis tellus fermentum
                        gravida. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla egestas dapibus semper.
            ...
            <div class="row rtl-cols">
                ...
                <div class="col-sm-8 col-md-8 info-text-holder">
                    <h3>Why Choose Hostio?</h3>
                    <p>Curabitur vulputate dignissim pretium. Integer viverra dignissim elit. Vestibulum aliquam erat eu
                        dictum porttitor. Aliquam feugiat risus lorem, non tempor purus egestas at. Nulla imperdiet tortor
                        id aliquet gravida. Phasellus dapibus id dolor viverra ultricies. Suspendisse ut finibus nulla.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row-subtitle">Phasellus accumsan nisi eu arcu condimentum sollicitudin. Nulla auctor quis
                        est at suscipit. <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row-subtitle">Etiam condimentum metus rhoncus purus pharetra tempor. <br />Sed faucibus
                        lectus quis tellus fermentum gravida.</div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-details">Lorem Ipsum which looks reasonable generated as default model as
                            and search many web sites pass websites is therefore always.</div>
                        <div class="testimonial-info"><span class="name">John Doe</span> - Manager @ Brandio
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4">
