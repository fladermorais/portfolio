                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="ativaBlog" id="ativaBlog" class="form-control">
                            <option {{ isset($info['ativaBlog']) && $info['ativaBlog'] == 'sim' ? 'selected' : '' }} value="sim">Sim</option>
                            <option {{ isset($info['ativaBlog']) && $info['ativaBlog'] == 'nao' ? 'selected' : '' }} value="nao">Não</option>
                        </select>
